      ...
      <div className="mb-4 flex items-center justify-between gap-4">
        <div>
          ...
          <h2 className="text-lg font-semibold text-white">
            Agent throughput, graph density, and explainability coverage
          </h2>
        </div>
        <p className="max-w-sm text-right text-xs text-slate-400">
          Synthetic streaming values update the dashboard feel without needing a
          backend during the initial demo.
        </p>
      </div>
      <div className="h-72">
